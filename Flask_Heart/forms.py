...
class SendToHeartApiForm(FlaskForm):
    ...
    chest_pain_type = SelectField('Chest Pain Type', choices=[('--Please choose an option--', ''), ('ASY', 'ASY'), ('ATA', 'ATA'), ('NAP', 'NAP'), ('TA', 'TA')], validators=[DataRequired()])
    resting_ecg = SelectField('Resting ECG', choices=[('--Please choose an option--', ''), ('LVH', 'LVH'), ('normal', 'Normal'), ('ST', 'ST')], validators=[DataRequired()])
    st_slope = SelectField('ST Slope', choices=[('--Please choose an option--', ''), ('down', 'Down'), ('flat', 'Flat'), ('up', 'Up')], validators=[DataRequired()])
